...
if TYPE_CHECKING:
    from app.models.models_material import InventoryMovement
    from app.models.models_product import ProductionOrder
...
class User(SQLModel, table = True):
    ...
    work_unit : Optional[WorkUnit] = Relationship(back_populates = "users")
